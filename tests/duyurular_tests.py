...
def test_file_writing_valid():
    ...
    duyurular.write_to_tempfile(mock_array, "/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_valid_output.txt")

    result_buffer = []
    with open('/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_valid_output.txt', 'r') as file1:
        for line in file1:
...
def test_file_writing_empty():
    ...
    duyurular.write_to_tempfile([], "/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_empty_output.txt")

    result_buffer = []
    with open('/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_empty_output.txt', 'r') as file1:
        for line in file1:
            result_buffer.append(line.strip('\n'))
...
def test_reading_valid_hat():
    ...
    result = duyurular.read_from_tempfile('98TB', "/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_valid_output.txt")
...
def test_reading_invalid_hat():
    ...
    result = duyurular.read_from_tempfile('abc', "/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_valid_output.txt")
...
def test_reading_emptyfile():
    ...
    results = duyurular.read_from_tempfile('98TB',"/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_empty_output.txt")
...
def test_cleanup():
    os.remove("/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_valid_output.txt")
    os.remove("/home/lolundcmd/Desktop/IETT_API_Tools/tests/test_filewriting_empty_output.txt")
